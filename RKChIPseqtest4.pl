...
my $query = '/mnt/iscsi_speed/blelloch/Raga/RK_2013/R_8.fastq';
my $outfile = '/mnt/iscsi_speed/blelloch/Raga/samtools/tR_8.sam';


#system "$bowtie_executable -p 4 -q -N 0 -k 1 $genome $query -S $outfile";
#system "$bowtie_executable -p 4 -q -D 15 -R 2 -N 0 -L 20 -i S,1,0.75 -k 1 $genome $query -S $outfile";
system "$bowtie_executable -p 4 -q -D 15 -R 2 -L 22 -i S,1,1.15 -k 1 $genome $query -S $outfile";
