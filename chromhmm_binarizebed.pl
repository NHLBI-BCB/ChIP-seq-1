...
my $binin = ('/N/dc2/projects/RNAMap/raga/chromhmm/ChromHMM/binin/');
my $out = ('/N/dc2/projects/RNAMap/raga/chromhmm/ChromHMM/K4me1_K27a_K27me3_p300/');
my $sizes = ('/N/dc2/projects/RNAMap/raga/chromhmm/ChromHMM/mm10.chrom.sizes');

system "$java -Xmx200M -jar $chromhmm BinarizeBed $sizes $binin $list $out";